...
int main()
{
    ...
    int scorePlayer{ 0 }, scoreOpponent{ 0 }, shot, teamSpirit{ 20 };
...
bool playerAttack(int& scorePlayer, int& scoreOpponent, int& shot, int& defense, int& teamSpirit)
{
    if (scorePlayer - scoreOpponent >= 1 && teamSpirit < 100)
    {
        teamSpirit += 5;
    }
    else if (scorePlayer - scoreOpponent <= -1 && teamSpirit > -100)
    {
        teamSpirit -= 5;
    }
